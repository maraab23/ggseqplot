...
Currently, [`{ggseqplot}`](https://maraab23.github.io/ggseqplot/) contains the 
following functions:
...
You can install [`{ggseqplot}`](https://maraab23.github.io/ggseqplot/) by typing:
...
I'd like to thank Gilbert Ritschard, Tim Liao, and Emanuela Struffolino for 
their comments on earlier version of this library. 
