...
[`{TraMineRextras}`](http://traminer.unige.ch){target="_blank"}. In
...
| `ggseqplot`          | `TraMineR::seqstatd`                                         | `ggplot2::geom_line`                                                                                                                    |
...
| `ggseqrfplot`        | tweaked version of:<br>`TraMineRextras::seqplot.rf` | `ggplot2::geom_rect`<br>`ggplot2::geom_boxplot`<br>[`{patchwork}`](https://patchwork.data-imaginist.com/index.html){target="_blank"} (to combine plots)                                                              |
...
this code will not produce the desired result, because `scale_x_discrete` will
